//
//  SCNClassifiedTwoViewController.m
//  SCN
//
...
@implementation SCNClassifiedTwoViewController

@synthesize m_tableview;
@synthesize m_TwoClassifiedId;
...
- (void)viewDidLoad {
    [super viewDidLoad];
	self.title = self.m_TwoClassifiedId;
}
...
{
	static NSString *CellIdentifier = @"ClassifiedTwoTableIdentifier";
	...
	NSString *string = [NSString stringWithFormat:@"三级分类%@",[NSNumber numberWithInt:index]];
